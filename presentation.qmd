...
subtitle: |
  ...
  <audio controls src="audio/test-sound-effect.mp3"></audio>
...
## Example Jokes {.pin-audio}

<audio controls src="audio/test-sound-effect.mp3"></audio>

![](images/ahn/examples/example-jokes.png)

## Plot 1 - Theme prevalence (Bar) {.pin-audio}
...
## Plot 2 - Scores by theme (Box) {.pin-audio}
...
## Plot 3 - Scores by # of themes (Box) {.pin-audio}
...
## Plot 4 - Scores by joke length, by theme (Scatter) {.pin-audio}

<audio controls src="audio/test-sound-effect.mp3"></audio>

![](images/ahn/4-scatter_plot_length_vs_score_default.png){width=50%}
